...
{/* <h1 className='text-3xl text-green-600 mt-5 mb-5 px-4'><strong>MLS Streams - MLS Soccer Streams</strong></h1> */}

<div className="m-2">
  <div className="flex flex-wrap">
    {/* Combined Column */}
    <h1 className='text-3xl text-green-600 mt-5 mb-24 px-4'><strong>MLS Streams - MLS Soccer Streams</strong></h1>
    <div className="w-full md:w-2/3 overflow-y-auto md:h-screen">
    ...
    {/* Sidebar */}
    <div className="w-full md:w-1/3 md:sticky -inset-0 py-4 px-4">
      {/* Sidebar content */}
